...
| 15 | Muss | Funktional | Als Kandidat möchte ich dass die Anzahl der Spielrunden gezählt werden, damit ich diese in der Highscore-Liste sichtbar ist. |
...
| 17 | Muss | Funktional | Als Entwickler möchte ich Transaktionsmanagement einsetzen, um die Integrität der Daten zu gewährleisten, damit ich die Datenintegrität sicherstellen kann. |
| 18 | Muss | Funktional | Als Entwickler möchte ich Sicherheitsaspekte implementieren, um die Anwendung und die Daten zu schützen, damit ich die Sicherheit sicherstellen kann. |
...
| ---- | ------------ | ------- | ----------------- |
| 1.1  |Administrator-Konto erstellt|1. Benutzername: admin 2. Passwort: admin123| 3. Admin-Inerface Seite im Reiter sichtbar |
| 2.2  |Administrator angemeldet, Admin-Inerface Seite offen, Liste enthält Einträge|1. "Programmieren" in Eingabfeld "Wort/Phrase" eingeben 2. "Hinzufügen" anklicken |4. Wort "Programmieren" erscheint oben in der Liste.|
| 2.2  |Administrator angemeldet, Admin-Inerface Seite offen, Liste enthält Einträge|1. "2" in Eingabfeld "Index" eingeben 2. "Programmieren" in Eingabefeld "Wort/Phrase" eingeben 3. "Bearbeiten" anklicken |4. Wort "Programmieren" erscheint oben in der Liste & Wort/Phrase mit Index 2 verschwindet.|
| 2.3  |Administrator angemeldet, Admin-Inerface Seite offen, Liste enthält Einträge|1. "2" in Eingabfeld "Index" eingeben 2. "Löschen" anklicken |Wort/Phrase mit Index 2 verschwindet.|
| 3.4  |Administrator angemeldet, Admin-Inerface Seite offen|1. Neue Kategorie: Tiere anlegen|2. Kategorie "Tiere" in ComboBox auswählbar|
| 3.5  |Administrator angemeldet, Admin-Inerface Seite offen|1. "Pfeilgiftfrosch" mit Kategorie "Tiere" hinzufügen	| 2. Pfeilgiftfrosch hat in der DB die Kategorie "Tiere"|
| 4.6  |Administrator angemeldet, Admin-Inerface Seite offen, Highscore-Liste enthält Einträge|1. "1" in Eingabfeld "Rang" eingeben 2. "Löschen" anklicken| 3. Eintrag auf Rang 1 verschwindet.|
...
| 6.8  | Webseite offen |1. "SpielerX" als Benutzernahme 2. Spiel spielen | 3. "SpielerX" in der Highscore-Liste sichtbar|
| 7.9  | Webseite offen |1. "SpielerX" als Benutzernahme 2. Spiel spielen | 3. "Kontostand: xxxx" |
| 8.10 | Webseite offen |1. "SpielerX" als Benutzernahme 2. Spiel spielen | 3. "Lebenspunkte: 3" |
| 9.11 | Webseite offen |1. "SpielerX" als Benutzernahme 2. Buchstaben falsch raten | 3. "Falsch"|
...
| 15.17 | Webseite offen |1. "SpielerX" als Benutzernahme 2. Spiel 3 Runden spielen | 3. "SpielerX" mit "3" Runden in der Highscore-Liste sichtbar|
...
| C.25 | Administrator angemeldet, Admin-Inerface Seite offen |1. "Programmieren" in Eingabfeld "Wort/Phrase" eingeben 2. "Mittel" auswählen 3. "Hinzufügen" anklicken |4. Wort "Programmieren" erscheint oben in der Liste.|
